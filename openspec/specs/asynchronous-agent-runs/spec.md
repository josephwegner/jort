# asynchronous-agent-runs Specification

## Purpose

Define secure OpenRouter connection management and bounded asynchronous execution of model-backed tools through Jort's shared tool lifecycle.
