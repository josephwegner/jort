# private-data-controls Specification

## Purpose

Define managed local-copy inventory, confirmed history and recovery purge, crash-consistent cleanup, diagnostic-backup retention, and the limits of logical deletion.
