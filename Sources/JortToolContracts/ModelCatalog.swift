...
public struct ModelCatalog: Codable, Equatable, Sendable {
  ...
  public static let bundled = ModelCatalog(
    ...
    models: [
      .init(
        id: defaultModelID, name: "GPT-5.4 Mini", provider: "OpenAI", maximumOutputTokens: 8192),
  ...
  public static func decode(_ data: Data) throws -> Self {
    ...
    guard value.schemaVersion == 1, value.models.count <= 100,
      ...
      value.models.allSatisfy({
        !$0.id.isEmpty && $0.id.utf8.count <= 256 && !$0.name.isEmpty && $0.name.utf8.count <= 128
          && $0.provider.utf8.count <= 128 && (1...8192).contains($0.maximumOutputTokens)
      })
  ...
  public func filter(_ query: String) -> [CatalogModel] {
    ...
    return models.filter {
      query.isEmpty || "\($0.name) \($0.provider)".localizedStandardContains(query)
    }
  }
}
